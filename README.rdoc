...
Tues:
* add seed data (including comments)
* get basic database to accept data
* show data (persist)
* schema and migrations set up?
...
* see a listing of locations when visiting the homepage
* click an existing listing to see comments and additional details
* input location of new development in the area
* users can enter new projects and/or add comments on existing projects
